      ...
      try {
        ...
        while (!aborted) {
          if (round % 2 === 0) {
            ...
            const { dx, dy } = {
              dx: x ?? warder.gameData.movementBuffer.dx,
              dy: y ?? warder.gameData.movementBuffer.dy
            };
            ...
            const { dx, dy } = {
              dx: x ?? prisoner.gameData.movementBuffer.dx,
              dy: y ?? prisoner.gameData.movementBuffer.dy
            };
